...
import { config, getAnunciosDestaque } from "@/lib/data";
...
export default function HomePage() {
  const destaques = getAnunciosDestaque();
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-600 mt-2 max-w-xl mx-auto">
              Geladeiras, freezers, lavadoras e ar condicionado. Atendemos em domicílio.
            </p>
          </motion.div>
          <motion.div
          ...
          >
            {servicos.map((s) => (
              <motion.div
                ...
                className="bg-slate-50 rounded-2xl p-8 text-center border border-slate-100 hover:border-teal-200 hover:shadow-lg hover:shadow-teal-500/5 transition-all duration-300"
              >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Link href="/servicos" className="text-brand-primary font-semibold hover:underline">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-600 mt-2">
              Geladeiras e freezers novos e usados. Compre pelo WhatsApp.
            </p>
          </motion.div>
          <motion.div
          ...
          >
            {destaques.length > 0 ? (
              destaques.map((a) => <CardAnuncio key={a.id} anuncio={a} />)
            ) : (
              <p className="text-slate-500 col-span-full text-center py-8">Em breve novos itens.</p>
            )}
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {config.telefones.map((t) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-[#25D366] text-white px-5 py-2.5 rounded-xl font-medium hover:bg-[#20bd5a] transition"
              >
                {t.label}
              </a>
            ))}
          </div>
          <Link href="/contato" className="inline-block mt-6 text-brand-primary font-semibold hover:underline">
            Ver endereço e mapa →
          </Link>
        </div>
      </section>

      {/* Quem somos - no final da página principal */}
          ...
          >
            ...
            <div className="text-slate-600 space-y-4 leading-relaxed">
              <p>
                ...
                especializada em refrigeração e eletrodomésticos, atendendo{" "}
                <strong className="text-slate-800">Pinheiral</strong>,{" "}
                <strong className="text-slate-800">Volta Redonda</strong> e toda a região.
              </p>
              <p>
                ...
                <strong className="text-slate-800">ar condicionado</strong>, com atendimento ágil e preço justo.
                Também trabalhamos com a venda de equipamentos novos e usados.
              </p>
              <p>
